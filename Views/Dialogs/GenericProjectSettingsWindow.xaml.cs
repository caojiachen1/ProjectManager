...
{
    public partial class GenericProjectSettingsWindow : FluentWindow
    {
        public GenericProjectSettingsViewModel ViewModel { get; }

        public GenericProjectSettingsWindow(GenericProjectSettingsViewModel viewModel)
        {
            ViewModel = viewModel;

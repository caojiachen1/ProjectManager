...
{
    public partial class NodeJSProjectSettingsWindow : FluentWindow
    {
        public NodeJSProjectSettingsViewModel ViewModel { get; }

        public NodeJSProjectSettingsWindow(NodeJSProjectSettingsViewModel viewModel)
        {
            ViewModel = viewModel;

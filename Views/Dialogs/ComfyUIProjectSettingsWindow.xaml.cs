...
{
    public partial class ComfyUIProjectSettingsWindow : FluentWindow
    {
        public ComfyUIProjectSettingsViewModel ViewModel { get; }

        public ComfyUIProjectSettingsWindow(ComfyUIProjectSettingsViewModel viewModel)
        {
            ViewModel = viewModel;
